...
if (preg_match('/^(\/start|\.start|!start)/', $text)) {
    if (in_array($userId, $freeusers)) {
        $caption = "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 <code>@$username</code> 𝘁𝗼 𝙰𝚗𝚝𝚒𝚏𝚒𝚎𝚍𝙽𝚞𝚕𝚕 𝙲𝚑𝚎𝚊𝚔𝚎𝚛 💖
        ...
        'inline_keyboard' => [
            [
                             ['text' => '𝙂𝘼𝙏𝙀𝙒𝘼𝙔𝙎', 'callback_data' => 'gates'],
                                 ...
                                 [
                                 ['text' => '@AntifiedNull_Channel', 'callback_data' => 'channel'],
                             ],
        ]
    ]);

    $caption = "Welcome To 𝙰𝚗𝚝𝚒𝚏𝚒𝚎𝚍𝙽𝚞𝚕𝚕 𝙲𝚑𝚎𝚊𝚔𝚎𝚛. Buy The Plan First.  /price 
...

{
 ...
 $caption=" Pricing 𝙰𝚗𝚝𝚒𝚏𝚒𝚎𝚍𝙽𝚞𝚕𝚕 𝙲𝚑𝚎𝚊𝚔𝚎𝚛📍
━━━━━━━━━━━━━━━━━━
⑄ 𝙎𝙐𝘽𝙎𝘾𝙍𝙄𝙋𝙏𝙄𝙊𝙉 𝙈𝙀𝙉𝙐 ⑄
━━━━━━━━━━━━━━━━━━
× 1 𝘞𝘌𝘌𝘒  - 2$
