...
$botToken = "6526901669:AAHXKLGRhZp-iebTL18OWNhPH6MvEe_0OHQ";
...
$emojid = '❌';
$emojil = '✅';
$owner = '<code>@AntifiedNull</code>';
$botu = "𝘽𝙊𝙏 𝙐𝙋𝘿𝘼𝙏𝙀𝙎 ↯ @AntifiedNull_Channel";
$bota = "<b>|×| 𝘿𝙀𝙑 ↯ @AntifiedNull</b>";$eror = "<b>Error ❌</b>";
...
if ($cdata2 == "back2") {
    $gatesText = "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝗧𝗼 𝗥𝗼𝗼𝗸. ⚠️ 𝗕𝘂𝘆 𝗧𝗵𝗲 𝗣𝗹𝗮𝗻 𝗙𝗶𝗿𝘀𝘁.";
...
━━━━━━━━━━━━━━━━━━
• 𝙋𝘼𝙔𝙈𝙀𝙉𝙏 𝙈𝙀𝙏𝙃𝙊𝘿 •
  🔸BTC - <code>DM @AntifiedNull</code>
  🔸LTC - <code>DM @AntifiedNull</code>
  🔸USDT - <code>DM @AntifiedNull</code>
  🔸BNB - <code>DM @AntifiedNull</code>
...
⚠️ 𝘛𝘏𝘐𝘚 𝘛𝘖𝘗-𝘜𝘗s 𝘈𝘙𝘌 𝘕𝘖𝘕 𝘙𝘌𝘍𝘜𝘕𝘋𝘈𝘉𝘓𝘌 ⚠️";
                                 ...
                                 $gatesKeyboard = json_encode([
                                 'inline_keyboard' => [
                                     [                     ['text' => '• 𝙑𝙀𝙍𝙄𝙁𝙔 𝙋𝘼𝙔𝙈𝙀𝙉𝙏 •', 'url' => 'https://t.me/AntifiedNull'],   ], ]
  ]);
...
$keyboard = json_encode([
    'inline_keyboard' => [
        [
            ['text' => "↯ 𝘽𝙐𝙔 𝘼𝘾𝘾𝙀𝙎𝙎", 'url' => "https://t.me/AntifiedNull"],
        ],
    ]
]);
...
$channel = json_encode([
    'inline_keyboard' => [
        [['text' => "𝙊𝙒𝙉𝙀𝙍", 'url' => "t.me/AntifiedNull"], ['text' => "𝘾𝙃𝘼𝙉𝙉𝙀𝙇", 'url' => "https://t.me/AntifiedNull_Channel"]],
        [['text' => "𝙂𝙊 𝘽𝘼𝘾𝙆 ", 'callback_data' => 'back2']]
    ]
]);
...
//==========back and close========//
if ($cdata2 == "back2") {
    $backtxt = ("𝚆𝚎𝚕𝚌𝚘𝚖𝚎  𝙲𝚕𝚒𝚌𝚔 /price 𝚃𝚘 𝙱𝚞𝚢 𝙿𝚛𝚎𝚖𝚒𝚞𝚖 𝙿𝚕𝚊𝚗 🔥");
    ...
    'inline_keyboard' => [
        ...
        [
            ['text' => '𝗕𝗢𝗧 𝗨𝗣𝗗𝗔𝗧𝗘𝗦', 'callback_data' => '𝗖𝗛𝗔𝗡𝗡𝗘𝗟'],
        ],
    ]
]);
